...
ライフゲームのルールはしばしば、生物の繁殖の特徴にも例えられます。適度な密度で黒マスが誕生・生存し、過疎でも過密でも死亡して白マスに戻ります。

### セルオートマトンの特徴
他の数理モデルと比較して、セルオートマトンのもっとも際立った特徴は**離散性**にあると言えます。

空間はセル、時間は世代という最小単位に分割されており、離散的になっています。セルがとる状態も離散的です。
